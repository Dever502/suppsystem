...
исходный текст и список тегов записываются в `quick_responses`, а бот ставит реакцию `✅`.
...
предупреждение и ставит `✅`. Повторные невалидные правки не продлевают исходный дедлайн.
