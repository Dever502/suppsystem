...
- общая закреплённая панель групп и персональный inline-каталог готовых ответов в Telegram;
...
2. Создайте бота через [@BotFather](https://t.me/BotFather), добавьте его администратором
   ...
   Для каталога готовых ответов включите Inline Mode командой `/setinline` в BotFather;
   подходящий placeholder — `Выберите готовый ответ`.
...
Скрипт скачивает image `v3.0.0`, закрепляет фактически полученный digest, проверяет Compose и ждёт
