...
from resolvate.api_schemas import (
    CloseTicketRequest,
    IdempotencyKey,
    MessageResponse,
    MutationResponse,
...
from resolvate.models import Direction, TicketMessage, TicketStatus
from resolvate.runtime_defaults import API_OPERATOR_TELEGRAM_ID
