...
from suppsystem.telegram_constants import SUPPORT_PENDING_TEXT, WELCOME_TEXT
...
from suppsystem.telegram_topic_manager import TelegramTopicManager
...
class TelegramUserHandlers(TelegramTopicManager):
    ...
    async def handle_rating_callback(self, callback: CallbackQuery) -> None:
        ...
        logger.info(
            ...
            extra={
                "event": "suppsystem_rating_received" if queued else "suppsystem_rating_duplicate",
                "ticket_id": ticket.id,
